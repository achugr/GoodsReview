...
public class ListOfReviews {
    ...
    public void printReviews() {
        for (int i = 0; i < this.reviewsList.size(); ++i) {
            System.out.println(this.reviewsList.get(i).getId() + " " + this.reviewsList.get(
                    i).getProductId() + " " + this.reviewsList.get(i).getContent() + " " + this.reviewsList.get(
                    i).getAuthor() + " " + this.reviewsList.get(i).getDate() + " " + this.reviewsList.get(
                    i).getDescription() + " " + this.reviewsList.get(i).getSourceId() + " " + this.reviewsList.get(
                    i).getSourceUrl() + " " + this.reviewsList.get(i).getPositivity() + " " + this.reviewsList.get(
                    i).getImportance() + " " + this.reviewsList.get(i).getVotesYes() + " " + this.reviewsList.get(
                    i).getVotesNo());
